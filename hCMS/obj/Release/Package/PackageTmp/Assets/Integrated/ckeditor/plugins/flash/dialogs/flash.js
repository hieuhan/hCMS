...
(function () {
    ...
    var attributesMap = {
        ...
        flashvars: [{
            type: ATTRTYPE_PARAM, name: 'flashvars'
        }, {
            type: ATTRTYPE_EMBED, name: 'flashvars'
        }],
        name: [{
						    ...
						    children: [
							{
							    ...
							    onLoad: function () {
									...
									updatePreview = function (src) {
									    ...
									    dialog.preview.setHtml('<embed height="100%" width="100%" src="' + CKEDITOR.basePath + 'ckeditor/plugins/jwplayer/jwplayer/player.swf" flashvars="' + CKEDITOR.tools.htmlEncode(previewPreloader.getAttribute('flashvars'))
